...
import io.github.aeckar.hass.TypeFlagMismatchException
...
/**
 * Decodes type-specific data from Hass format, throwing [EOFException] if the underlying stream is exhausted.
 */
